...
<html lang="en">
  ...
  <head>
    ...
    <title>Booking Pendakian Online</title>
      ...
      <div class="container">
        ...
        <div class="row text-center">
          <div class="col-md-4">
            ...
            <h4 class="service-heading">Gunung</h4>
            <p class="text-muted">Menyajikan semua informasi mengenai gunung yang ada diIndonesia secara lengkap. Mulai dari lokasi,ketinggian, status gunung dan keadaan gunung </p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
          ...
          <div class="col-md-4">
            ...
            <h4 class="service-heading">Jalur Pendakian</h4>
            <p class="text-muted">Menyajikan informasi mengenai jalur pendakian dari gunung agar dapat memberikan informasi kepada calon pendaki agar meminimalisir tejadinya pendaki yang tersesat. </p>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="row">
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <h2 class="text-uppercase">GUNUNG BUTHAK</h2>
                  <p class="item-intro text-muted">Gn Butak, Dusun Toyomerto, Desa Pesanggrahan, Kecamatan Batu, Kota Batu Kota Batu, Jawa Timur</p>alt="">
                  <ul class="list-inline">
                    <li>Ketinggian: 2.868 mdpl</li>
                    <li>Status: Aktif</li>
